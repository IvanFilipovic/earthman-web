...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, setCookie, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, getRouterParam, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getCookie, getResponseStatusText } from 'file:///home/kai/Projekti/webshop/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/kai/Projekti/webshop/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/kai/Projekti/webshop/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///home/kai/Projekti/webshop/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/kai/Projekti/webshop/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/kai/Projekti/webshop/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/kai/Projekti/webshop/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/kai/Projekti/webshop/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/kai/Projekti/webshop/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/kai/Projekti/webshop/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///home/kai/Projekti/webshop/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/kai/Projekti/webshop/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/kai/Projekti/webshop/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/kai/Projekti/webshop/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/kai/Projekti/webshop/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/kai/Projekti/webshop/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/kai/Projekti/webshop/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/kai/Projekti/webshop/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/kai/Projekti/webshop/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/kai/Projekti/webshop/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/kai/Projekti/webshop/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/kai/Projekti/webshop/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/kai/Projekti/webshop/node_modules/vue/index.mjs';
import { createPathIndexLanguageParser, parseAcceptLanguage } from 'file:///home/kai/Projekti/webshop/node_modules/@intlify/utils/dist/index.mjs';
import { parse } from 'file:///home/kai/Projekti/webshop/node_modules/cookie-es/dist/index.mjs';
import { createRouterMatcher } from 'file:///home/kai/Projekti/webshop/node_modules/vue-router/dist/vue-router.node.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///home/kai/Projekti/webshop/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/kai/Projekti/webshop/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///home/kai/Projekti/webshop/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/kai/Projekti/webshop/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/kai/Projekti/webshop/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/kai/Projekti/webshop/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/kai/Projekti/webshop/node_modules/ipx/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/kai/Projekti/webshop/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/kai/Projekti/webshop","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/kai/Projekti/webshop/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/kai/Projekti/webshop/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/kai/Projekti/webshop/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/kai/Projekti/webshop/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/home/kai/Projekti/webshop/public"
      ]
    },
    "http": {
      "domains": []
...
const _N1KDIOjaJ2mX8zULXKEpCsJKPmOxGJGvDfUvyJPCms = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/home/kai/Projekti/webshop";
...
const _WB6Dh9NF9nkEWvBGjQAehEDPrhGb_tMqAsnV5pwoTrs = (nitroApp) => {
...
const _ifp7RgCKY8ciEdz4Rnc0BqLtKVIcRUEzFX_Oc7e0LCU = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const plugins = [
  _N1KDIOjaJ2mX8zULXKEpCsJKPmOxGJGvDfUvyJPCms,
_WB6Dh9NF9nkEWvBGjQAehEDPrhGb_tMqAsnV5pwoTrs,
...
const _fYz13F = eventHandler((event) => {
...
const _fCSiD_ = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _1yTGrJ = _messagesHandler ;
...
const getServerEntry = () => import('file:///home/kai/Projekti/webshop/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/kai/Projekti/webshop/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _NUlhEJ = lazyEventHandler(() => {
...
const _lazy_scZpHq = () => Promise.resolve().then(function () { return cart_delete$1; });
const _lazy_9hvoiE = () => Promise.resolve().then(function () { return cart_get$1; });
const _lazy_qNz1y0 = () => Promise.resolve().then(function () { return cart_put$1; });
const _lazy_0QEeZm = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _fYz13F, lazy: false, middleware: true, method: undefined },
  ...
  { route: '/_ipx/**', handler: _NUlhEJ, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_0QEeZm, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_0QEeZm, lazy: true, middleware: false, method: undefined }
];
...
const cart_delete$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: cart_delete
}, Symbol.toStringTag, { value: 'Module' }));
...
const cart_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: cart_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const cart_put$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: cart_put
}, Symbol.toStringTag, { value: 'Module' }));
