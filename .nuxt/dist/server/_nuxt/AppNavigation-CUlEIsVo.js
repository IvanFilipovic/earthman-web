...
import { s as useState, c as useRoute, d as __nuxt_component_3, _ as _export_sfc } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-d89ed18d><div class="hidden md:flex flex-col lg:flex-row w-full" data-v-d89ed18d><div class="flex flex-col w-full lg:w-1/2 h-full" data-v-d89ed18d><div class="absolute inset-x-0 top-0 w-1/2 h-full md:px-8" data-v-d89ed18d>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Earth Man Logo" class="max-w-[100%] h-auto object-contain" data-v-d89ed18d${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`</div></div><div class="hidden md:flex w-full items-start justify-end lg:w-1/2 px-4 md:px-8 md:py-14 lg:py-24 gap-6 h-full" data-v-d89ed18d><section class="flex flex-col justify-end w-full bg-transparent z-50 my-auto" data-v-d89ed18d><div class="flex pt-4" data-v-d89ed18d><div class="flex flex-row justify-end w-full mx-auto space-x-4 py-4" data-v-d89ed18d>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/shop",
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</div></section></div></div><section class="flex md:hidden flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 py-6 gap-6" data-v-d89ed18d><div class="flex md:hidden items-center justify-between w-full px-2" data-v-d89ed18d><div class="w-[60%] max-w-[200px]" data-v-d89ed18d>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "block"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Earth Man Logo" class="w-full h-auto max-h-12 object-contain object-left" data-v-d89ed18d${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`</div><div class="flex items-center gap-4" data-v-d89ed18d>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`<button type="button" aria-label="Open menu" data-v-d89ed18d>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d89ed18d"]]);
export {
  __nuxt_component_0 as _
};
//# sourceMappingURL=AppNavigation-CUlEIsVo.js.map
