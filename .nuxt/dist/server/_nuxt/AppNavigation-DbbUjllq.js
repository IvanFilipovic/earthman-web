...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-b14599c5><div class="hidden md:flex flex-col lg:flex-row w-full z-50" data-v-b14599c5><div class="flex flex-col w-full lg:w-1/2" data-v-b14599c5><div class="absolute inset-x-0 top-0 w-1/2 md:px-8" data-v-b14599c5>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Earth Man Logo" class="max-w-[100%] h-auto object-contain" data-v-b14599c5${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`</div></div><div class="hidden md:flex w-full items-start justify-end lg:w-1/2 px-4 md:px-8 md:py-14 lg:py-24 gap-6 h-full" data-v-b14599c5><section class="flex flex-col justify-end w-full bg-transparent z-50 my-auto" data-v-b14599c5><div class="flex pt-4" data-v-b14599c5><div class="flex flex-row justify-end w-full mx-auto space-x-4 py-4" data-v-b14599c5>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/shop",
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</div></section></div></div><section class="flex md:hidden flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 py-6 gap-6" data-v-b14599c5><div class="flex md:hidden items-center justify-between w-full px-2" data-v-b14599c5><div class="w-[60%] max-w-[200px]" data-v-b14599c5>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "block"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Earth Man Logo" class="w-full h-auto max-h-12 object-contain object-left" data-v-b14599c5${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`</div><div class="flex items-center gap-4" data-v-b14599c5>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`<button type="button" aria-label="Open menu" data-v-b14599c5>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b14599c5"]]);
export {
  __nuxt_component_0 as _,
  useCartStore as u
};
//# sourceMappingURL=AppNavigation-DbbUjllq.js.map
