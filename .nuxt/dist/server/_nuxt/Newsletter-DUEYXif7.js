import { defineComponent, mergeProps, useSSRContext, ref, computed, withCtx, createVNode, useAttrs, unref } from "vue";
...
import { _ as _export_sfc, g as useRouter, a as __nuxt_component_0$1, h as useRequestEvent, w as withLeadingSlash, i as hasProtocol, j as joinURL, p as parseURL, k as encodeParam, l as encodePath, m as useNuxtApp, f as useRuntimeConfig, u as useHead } from "../server.mjs";
/* empty css                         */
import "keen-slider";
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-5cbfbe57"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "py-28" }, _attrs))} data-v-e1de93e9><div class="keen-slider my-auto" data-v-e1de93e9><!--[-->`);
      ssrRenderList(computedSlides.value, (s, i) => {
        _push(`<div class="${ssrRenderClass([s.type === "cta" ? "slide-cta" : "slide-product", "keen-slider__slide px-2 my-auto"])}" data-v-e1de93e9>`);
        if (s.type === "cta") {
          _push(`<div class="w-full h-full" data-v-e1de93e9><button class="group w-full h-full flex items-center justify-center bg-background_color p-6 text-center" data-v-e1de93e9><div class="space-y-2" data-v-e1de93e9><h3 class="text-xl md:text-2xl font-bold" data-v-e1de93e9>${ssrInterpolate(s.cta.title)}</h3><p class="text-sm opacity-80" data-v-e1de93e9>${ssrInterpolate(s.cta.subtitle)}</p><div to="/shop" class="primary-btn sweep mx-auto px-4 py-2 md:w-full text-center" data-v-e1de93e9><span class="btn-label" data-v-e1de93e9>${ssrInterpolate(s.cta.button)}</span><span class="sweep-overlay" aria-hidden="true" data-v-e1de93e9></span></div></div></button></div>`);
        } else {
          _push(`<div class="w-full" data-v-e1de93e9>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", firstColor(s.item)?.avatar_image || s.item.link_image)}${ssrRenderAttr("alt", s.item.alt_text || s.item.name)} class="w-full object-cover border border-text_color/30" loading="lazy" decoding="async" data-v-e1de93e9${_scopeId}>`);
              } else {
                return [
                  createVNode("img", {
          ...
          _push(`<div class="mt-3 text-text_color truncate text-center" data-v-e1de93e9><p class="text-xs font-light mb-1" data-v-e1de93e9>${ssrInterpolate(s.item.category)}</p><p class="text-sm" data-v-e1de93e9>${ssrInterpolate(s.item.name)}</p></div></div>`);
        }
        _push(`</div>`);
      });
      _push(`<!--]--></div></div>`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-e1de93e9"]]);
...
//# sourceMappingURL=Newsletter-DUEYXif7.js.map
