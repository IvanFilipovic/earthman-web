import { _ as __nuxt_component_0$1 } from "./AppNavigation-CXvNTMsr.js";
import { _ as __nuxt_component_0$2 } from "./nuxt-link-7pp3EPK3.js";
import { _ as __nuxt_component_0, u as useAsyncData } from "./index-Ccr6sSLn.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    async function fetchCartQuantity(variantSlug) {
      try {
        const cartData = await $fetch("/api/private/get/cart");
        const item = cartData?.items?.find((i) => i.product_variant_slug === variantSlug);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-a32eea4a>`);
      _push(ssrRenderComponent(_component_AppNavigation, { dark: false }, null, _parent));
      _push(`<div class="flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 pt-4 gap-2" data-v-a32eea4a><div class="flex justify-start w-full" data-v-a32eea4a><div class="flex items-center py-1 text-[12px] md:text-sm text-text_color uppercase tracking-widest" data-v-a32eea4a>`);
      ...
      _push(`<span class="pr-1 md:pr-2" data-v-a32eea4a>/</span>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/shop",
        class: "hover:underline pr-1 md:pr-2"
      }, {
      ...
      _push(`<span class="pr-1 md:pr-2" data-v-a32eea4a>/</span><span class="pr-1 md:pr-2" data-v-a32eea4a>${ssrInterpolate(unref(productName))}</span></div></div></div><div class="hidden md:block" data-v-a32eea4a><div class="relative grid grid-cols-12 gap-8 pt-8 mt-2 md:mt-6 px-4 md:px-8 items-start" data-v-a32eea4a><div class="md:col-span-8" data-v-a32eea4a>`);
      ...
      _push(`</div><aside class="md:col-span-4 md:sticky md:top-4 md:self-start" data-v-a32eea4a><div class="bg-background_color border border-text_color/30 p-5 align-self:start" data-v-a32eea4a><div class="flex items-start justify-between" data-v-a32eea4a><div data-v-a32eea4a><h1 class="text-sm font-light leading-tight text-text_color" data-v-a32eea4a>${ssrInterpolate(unref(productCategory))}</h1><h1 class="text-xl font-medium leading-tight text-text_color" data-v-a32eea4a>${ssrInterpolate(unref(productName))}</h1>`);
      if (unref(activeColorName)) {
        _push(`<p class="mt-1 text-sm text-text_color" data-v-a32eea4a>Color: ${ssrInterpolate(unref(activeColorName))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="text-right" data-v-a32eea4a>`);
      if (unref(product)?.discount) {
        _push(`<div class="space-x-2" data-v-a32eea4a><span class="text-lg font-semibold text-text_color" data-v-a32eea4a>€${ssrInterpolate(unref(product)?.discount_price)}</span><span class="line-through text-text_color" data-v-a32eea4a>€${ssrInterpolate(unref(product)?.price)}</span></div>`);
      } else {
        _push(`<div class="text-lg font-semibold text-text_color" data-v-a32eea4a>€${ssrInterpolate(unref(product)?.price)}</div>`);
      }
      _push(`</div></div>`);
      if (unref(variantGroups).length) {
        _push(`<div class="mt-4" data-v-a32eea4a><div class="text-xs uppercase tracking-widest mb-2" data-v-a32eea4a>Color</div><div class="flex gap-3" data-v-a32eea4a><!--[-->`);
        ssrRenderList(unref(variantGroups), (vg, idx) => {
          _push(`<button type="button" class="${ssrRenderClass([unref(activeColorIndex) === idx ? "ring-2 ring-text_color" : "", "w-8 h-8 border relative"])}"${ssrRenderAttr("title", vg.color?.name)} style="${ssrRenderStyle({ backgroundColor: swatchBg(vg.color?.image) })}" data-v-a32eea4a><span class="sr-only" data-v-a32eea4a>${ssrInterpolate(vg.color?.name)}</span></button>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(activeSizes).length) {
        _push(`<div class="mt-6" data-v-a32eea4a><div class="flex items-center justify-between" data-v-a32eea4a><div class="text-xs uppercase tracking-widest" data-v-a32eea4a>Size</div><div class="text-xs text-text_color/70" data-v-a32eea4a>`);
        if (unref(inStock)) {
          _push(`<span data-v-a32eea4a>In Stock</span>`);
        } else {
          _push(`<span data-v-a32eea4a>Unavailable</span>`);
        }
        _push(`</div></div><div class="mt-2 grid grid-cols-5 gap-2" data-v-a32eea4a><!--[-->`);
        ssrRenderList(unref(activeSizes), (s) => {
          ...
          ], "border px-2 py-2 text-sm text-text_color"])}"${ssrIncludeBooleanAttr(!s.available) ? " disabled" : ""} data-v-a32eea4a>${ssrInterpolate(s.size?.name)}</button>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="mt-6" data-v-a32eea4a><div class="text-xs uppercase tracking-widest mb-2" data-v-a32eea4a>Quantity</div><div class="flex items-center gap-3" data-v-a32eea4a><button type="button"${ssrIncludeBooleanAttr(unref(quantity) <= 1) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-40 cursor-not-allowed": unref(quantity) <= 1 }, "w-10 h-10 flex items-center justify-center border border-text_color/30 hover:bg-text_color/5 transition-colors duration-200"])}" data-v-a32eea4a>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:minus",
        class: "w-4 h-4 text-text_color"
      }, null, _parent));
      _push(`</button><input${ssrRenderAttr("value", unref(quantity))} type="number" min="1" max="99" class="w-16 h-10 text-center border border-text_color/30 bg-background_color text-text_color focus:outline-none focus:border-text_color" data-v-a32eea4a><button type="button"${ssrIncludeBooleanAttr(unref(quantity) >= 99) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-40 cursor-not-allowed": unref(quantity) >= 99 }, "w-10 h-10 flex items-center justify-center border border-text_color/30 hover:bg-text_color/5 transition-colors duration-200"])}" data-v-a32eea4a>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:plus",
        class: "w-4 h-4 text-text_color"
      }, null, _parent));
      ...
      if (unref(currentCartQuantity) > 0) {
        _push(`<p class="mt-2 text-xs text-text_color/70" data-v-a32eea4a>${ssrInterpolate(unref(currentCartQuantity))} already in cart </p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mt-6 space-y-3" data-v-a32eea4a><button type="button" class="btn btn--primary w-full"${ssrIncludeBooleanAttr(!unref(selectedVariantSlug)) ? " disabled" : ""} data-v-a32eea4a><span class="btn__text" data-v-a32eea4a>Add to Cart</span><span class="btn__fill" data-v-a32eea4a></span></button></div><ul class="mt-5 space-y-2 text-sm text-text_color/80" data-v-a32eea4a><li data-v-a32eea4a>✓ Free delivery over €250,-</li><li data-v-a32eea4a>✓ Easy returns within 14 days</li></ul></div></aside></div>`);
      ...
      _push(`</div><div class="block md:hidden mt-2 pt-8" id="mobile-product-wrap" data-v-a32eea4a>`);
      if (unref(variantGroups).length) {
        _push(`<div class="keen-slider" data-v-a32eea4a><!--[-->`);
        ssrRenderList(unref(variantGroups)[unref(activeColorIndex)]?.gallery || [], (img, i) => {
          _push(`<div class="keen-slider__slide" data-v-a32eea4a><img${ssrRenderAttr("src", img.image)}${ssrRenderAttr("alt", img.alt_text || unref(productName))} class="w-full h-auto object-cover border-t border-b border-text_color/30" data-v-a32eea4a></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(variantGroups).length) {
        _push(`<div class="flex items-center justify-center gap-2 py-3" data-v-a32eea4a><!--[-->`);
        ssrRenderList(unref(dots), (idx) => {
          _push(`<button type="button" class="flex items-center text-text_color"${ssrRenderAttr("aria-label", `Go to slide ${idx + 1}`)} data-v-a32eea4a>`);
          _push(ssrRenderComponent(_component_Icon, {
      ...
      if (unref(variantGroups).length) {
        _push(`<div class="pt-4 px-4" data-v-a32eea4a><div class="text-xs uppercase tracking-widest mb-2" data-v-a32eea4a>Color</div><div class="flex gap-3" data-v-a32eea4a><!--[-->`);
        ssrRenderList(unref(variantGroups), (vg, idx) => {
          _push(`<button type="button" class="${ssrRenderClass([unref(activeColorIndex) === idx ? "ring-2 ring-text_color" : "", "w-8 h-8 border"])}" style="${ssrRenderStyle({ backgroundColor: swatchBg(vg.color?.image) })}" data-v-a32eea4a><span class="sr-only" data-v-a32eea4a>${ssrInterpolate(vg.color?.name)}</span></button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(activeColorName)) {
          _push(`<p class="mt-1 text-sm text-text_color" data-v-a32eea4a> Color: ${ssrInterpolate(unref(activeColorName))}</p>`);
      ...
      _push(`<div class="px-4 mt-4" data-v-a32eea4a>`);
      _push(ssrRenderComponent(_component_ProductAccordion, {
        items: [
...
We accept returns within 14 days. Sale items can only be refunded as store credit.`,
      ...
      _push(`</div><div class="sticky bottom-0 left-0 w-full bg-background_color z-40" data-v-a32eea4a><div class="flex flex-col items-start py-6 px-4 gap-4" data-v-a32eea4a><div data-v-a32eea4a><h1 class="text-sm font-light leading-tight text-text_color" data-v-a32eea4a>${ssrInterpolate(unref(productCategory))}</h1><h1 class="text-lg font-medium leading-tight text-text_color" data-v-a32eea4a>${ssrInterpolate(unref(productName))}</h1></div><div class="text-right" data-v-a32eea4a>`);
      if (unref(product)?.discount) {
        _push(`<div class="space-x-1" data-v-a32eea4a><span class="text-base font-semibold text-text_color" data-v-a32eea4a>€${ssrInterpolate(unref(product)?.discount_price)}</span><span class="line-through text-text_color text-sm" data-v-a32eea4a>€${ssrInterpolate(unref(product)?.price)}</span></div>`);
      } else {
        _push(`<div class="text-base font-semibold text-text_color" data-v-a32eea4a>€${ssrInterpolate(unref(product)?.price)}</div>`);
      }
      _push(`</div><button type="button" class="w-full py-2 my-auto items-center text-center text-base font-medium tracking-wider bg-text_color text-background_color" data-v-a32eea4a><span class="my-auto" data-v-a32eea4a>ADD</span></button></div></div>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Dialog), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="fixed inset-0 bg-text_color/30" aria-hidden="true" data-v-a32eea4a${_scopeId2}></div><div class="fixed bottom-0 w-screen" data-v-a32eea4a${_scopeId2}>`);
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(DialogPanel), { class: "w-full bg-background_color p-6" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="flex justify-between items-center mb-4" data-v-a32eea4a${_scopeId4}><h2 class="text-base uppercase tracking-wider font-medium" data-v-a32eea4a${_scopeId4}>Select Size &amp; Quantity</h2></div>`);
                              if (unref(activeSizes).length) {
                                _push5(`<div class="mt-4" data-v-a32eea4a${_scopeId4}><div class="text-xs uppercase tracking-widest mb-2" data-v-a32eea4a${_scopeId4}>Size</div><div class="flex flex-col justify-center gap-3 items-center" data-v-a32eea4a${_scopeId4}><!--[-->`);
                                ssrRenderList(unref(activeSizes), (s) => {
                                  _push5(`<button type="button" class="${ssrRenderClass([[
                                    s.available ? "cursor-pointer" : "opacity-40 cursor-not-allowed",
                                    unref(selectedVariantSlug) === s.slug ? "border-text_color" : "border-project_gray/50"
                                  ], "border px-3 py-2 text-sm w-fit"])}"${ssrIncludeBooleanAttr(!s.available) ? " disabled" : ""} data-v-a32eea4a${_scopeId4}>${ssrInterpolate(s.size?.name)}</button>`);
                                });
                                _push5(`<!--]--></div></div>`);
                              } else {
                                _push5(`<!---->`);
                              }
                              _push5(`<div class="mt-6" data-v-a32eea4a${_scopeId4}><div class="text-xs uppercase tracking-widest mb-2" data-v-a32eea4a${_scopeId4}>Quantity</div><div class="flex items-center justify-center gap-3" data-v-a32eea4a${_scopeId4}><button type="button"${ssrIncludeBooleanAttr(unref(quantity) <= 1) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-40 cursor-not-allowed": unref(quantity) <= 1 }, "w-10 h-10 flex items-center justify-center border border-text_color/30 hover:bg-text_color/5 transition-colors duration-200"])}" data-v-a32eea4a${_scopeId4}>`);
                              _push5(ssrRenderComponent(_component_Icon, {
                                name: "lucide:minus",
                                class: "w-4 h-4 text-text_color"
                              }, null, _parent5, _scopeId4));
                              _push5(`</button><input${ssrRenderAttr("value", unref(quantity))} type="number" min="1" max="99" class="w-16 h-10 text-center border border-text_color/30 bg-background_color text-text_color focus:outline-none focus:border-text_color" data-v-a32eea4a${_scopeId4}><button type="button"${ssrIncludeBooleanAttr(unref(quantity) >= 99) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-40 cursor-not-allowed": unref(quantity) >= 99 }, "w-10 h-10 flex items-center justify-center border border-text_color/30 hover:bg-text_color/5 transition-colors duration-200"])}" data-v-a32eea4a${_scopeId4}>`);
                              _push5(ssrRenderComponent(_component_Icon, {
                                name: "lucide:plus",
                                class: "w-4 h-4 text-text_color"
                              }, null, _parent5, _scopeId4));
                              _push5(`</button></div>`);
                              if (unref(currentCartQuantity) > 0) {
                                _push5(`<p class="mt-2 text-xs text-center text-text_color/70" data-v-a32eea4a${_scopeId4}>${ssrInterpolate(unref(currentCartQuantity))} already in cart </p>`);
                              } else {
                                _push5(`<!---->`);
                              }
                              _push5(`</div><button type="button" class="mt-6 w-full py-3 text-base font-medium tracking-wider bg-text_color text-background_color disabled:opacity-50 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(!unref(selectedVariantSlug)) ? " disabled" : ""} data-v-a32eea4a${_scopeId4}> ADD TO CART </button>`);
                            } else {
                              return [
...
const ____product_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a32eea4a"]]);
export {
  ____product_ as default
};
//# sourceMappingURL=_...product_-Cns2yiNC.js.map
