...
import { d as __nuxt_component_0, _ as _export_sfc, e as useRoute, o as useAsyncData, m as useNuxtApp, g as useRuntimeConfig, a as __nuxt_component_0$2 } from "../server.mjs";
import { defineComponent, ref, computed, mergeProps, unref, useSSRContext, withCtx, createVNode, createBlock, createCommentVNode, toDisplayString, openBlock, resolveDynamicComponent, Transition, withAsyncContext, watch, nextTick, createTextVNode, Fragment, renderList } from "vue";
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(product)?.discount) {
        _push(`<div class="space-x-2" data-v-78e0f183><span class="text-lg font-semibold text-text_color" data-v-78e0f183>€${ssrInterpolate(unref(product)?.discount_price)}</span><span class="line-through text-text_color" data-v-78e0f183>€${ssrInterpolate(unref(product)?.price)}</span></div>`);
      } else {
        _push(`<div class="text-lg font-semibold text-text_color" data-v-78e0f183>€${ssrInterpolate(unref(product)?.price)}</div>`);
      }
      _push(`</div></div>`);
      if (unref(variantGroups).length) {
        ...
        ssrRenderList(unref(variantGroups), (vg, idx) => {
          _push(`<button type="button" class="${ssrRenderClass([unref(activeColorIndex) === idx ? "ring-2 ring-text_color" : "", "w-8 h-8 border relative"])}"${ssrRenderAttr("title", vg.color?.name)} style="${ssrRenderStyle({ backgroundColor: swatchBg(vg.color?.image) })}" data-v-78e0f183><span class="sr-only" data-v-78e0f183>${ssrInterpolate(vg.color?.name)}</span></button>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(activeSizes).length) {
        ...
        ssrRenderList(unref(activeSizes), (s) => {
          ...
          ], "border px-2 py-2 text-sm text-text_color"])}"${ssrIncludeBooleanAttr(!s.available) ? " disabled" : ""} data-v-78e0f183>${ssrInterpolate(s.size?.name)}</button>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(variantGroups).length) {
        ...
        ssrRenderList(unref(variantGroups), (vg, idx) => {
          _push(`<button type="button" class="${ssrRenderClass([unref(activeColorIndex) === idx ? "ring-2 ring-text_color" : "", "w-8 h-8 border"])}" style="${ssrRenderStyle({ backgroundColor: swatchBg(vg.color?.image) })}" data-v-78e0f183><span class="sr-only" data-v-78e0f183>${ssrInterpolate(vg.color?.name)}</span></button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(activeColorName)) {
          _push(`<p class="mt-1 text-sm text-text_color" data-v-78e0f183> Color: ${ssrInterpolate(unref(activeColorName))}</p>`);
...
We accept returns within 14 days. Sale items can only be refunded as store credit.`,
      ...
      if (unref(product)?.discount) {
        _push(`<div class="space-x-1" data-v-78e0f183><span class="text-base font-semibold text-text_color" data-v-78e0f183>€${ssrInterpolate(unref(product)?.discount_price)}</span><span class="line-through text-text_color text-sm" data-v-78e0f183>€${ssrInterpolate(unref(product)?.price)}</span></div>`);
      } else {
        _push(`<div class="text-base font-semibold text-text_color" data-v-78e0f183>€${ssrInterpolate(unref(product)?.price)}</div>`);
      }
                              ...
                              if (unref(activeSizes).length) {
                                ...
                                ssrRenderList(unref(activeSizes), (s) => {
                                  _push5(`<button type="button" class="${ssrRenderClass([[
                                    s.available ? "cursor-pointer" : "opacity-40 cursor-not-allowed",
                                    unref(selectedVariantSlug) === s.slug ? "border-text_color" : "border-project_gray/50"
                                  ], "border px-3 py-2 text-sm w-fit"])}"${ssrIncludeBooleanAttr(!s.available) ? " disabled" : ""} data-v-78e0f183${_scopeId4}>${ssrInterpolate(s.size?.name)}</button>`);
                                });
                                _push5(`<!--]--></div></div>`);
                              } else {
                                _push5(`<!---->`);
...
//# sourceMappingURL=_...product_-DytwA0_E.js.map
