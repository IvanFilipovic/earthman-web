import { _ as __nuxt_component_0$2 } from "./AppNavigation-CUlEIsVo.js";
import { defineComponent, ref, watch, nextTick, mergeProps, useSSRContext, computed, unref, withCtx, createVNode, withAsyncContext } from "vue";
...
/* empty css                         */
import { _ as __nuxt_component_0$1, u as useAsyncData } from "./index-Ccr6sSLn.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "collection-page" }, _attrs))} data-v-ba0e742e><div class="fixed top-0 left-0 w-full z-50" data-v-ba0e742e>`);
      _push(ssrRenderComponent(_component_AppNavigation, { dark: false }, null, _parent));
      _push(`</div><div class="pt-20 relative z-10" data-v-ba0e742e><div class="flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 pt-4 gap-6" data-v-ba0e742e><div class="flex justify-start w-full" data-v-ba0e742e><div class="flex items-center gap-1" data-v-ba0e742e><button type="button" class="${ssrRenderClass(typeBtnClass("all"))}" data-v-ba0e742e> ALL </button><button type="button" class="${ssrRenderClass(typeBtnClass("woman"))}" data-v-ba0e742e> WOMAN </button><button type="button" class="${ssrRenderClass(typeBtnClass("man"))}" data-v-ba0e742e> MAN </button><button type="button" class="${ssrRenderClass(typeBtnClass("kids"))}" data-v-ba0e742e> KIDS </button></div></div></div>`);
...
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ba0e742e"]]);
export {
  ____slug_ as default
};
//# sourceMappingURL=_...slug_-CiKLIyRS.js.map
