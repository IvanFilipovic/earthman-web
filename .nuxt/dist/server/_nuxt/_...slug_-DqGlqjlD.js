...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "collection-page" }, _attrs))} data-v-191cb41b><div class="w-full z-50" data-v-191cb41b>`);
      _push(ssrRenderComponent(_component_AppNavigation, { dark: false }, null, _parent));
      _push(`</div><div class="pt-20 relative z-10" data-v-191cb41b><div class="flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 pt-4 gap-6" data-v-191cb41b><div class="flex justify-start w-full" data-v-191cb41b><div class="flex items-center gap-1" data-v-191cb41b><button type="button" class="${ssrRenderClass(typeBtnClass("all"))}" data-v-191cb41b> ALL </button><button type="button" class="${ssrRenderClass(typeBtnClass("woman"))}" data-v-191cb41b> WOMAN </button><button type="button" class="${ssrRenderClass(typeBtnClass("man"))}" data-v-191cb41b> MAN </button><button type="button" class="${ssrRenderClass(typeBtnClass("kids"))}" data-v-191cb41b> KIDS </button></div></div></div>`);
...
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-191cb41b"]]);
export {
  ____slug_ as default
};
//# sourceMappingURL=_...slug_-DqGlqjlD.js.map
