import { _ as __nuxt_component_0 } from "./AppNavigation-CUlEIsVo.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-e82120d2>`);
      _push(ssrRenderComponent(_component_AppNavigation, { dark: false }, null, _parent));
      _push(`<div class="flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 pt-4 gap-6" data-v-e82120d2><div class="flex justify-start w-full" data-v-e82120d2><nav class="flex items-center py-1 text-xs md:text-sm text-text_color uppercase tracking-widest" aria-label="Breadcrumb" data-v-e82120d2>`);
      ...
      _push(`<span class="pr-2" aria-hidden="true" data-v-e82120d2>/</span>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/shop",
        class: "hover:underline pr-2"
      }, {
      ...
      _push(`<span class="pr-2" aria-hidden="true" data-v-e82120d2>/</span><span class="pr-2" aria-current="page" data-v-e82120d2>CHECKOUT</span></nav></div></div><div class="hidden md:flex flex-col md:flex-row py-8 md:px-8 mt-6 md:gap-x-16" data-v-e82120d2>`);
      _push(ssrRenderComponent(unref(Form), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-8" data-v-e82120d2${_scopeId}><h3 class="text-base uppercase tracking-widest py-2 -mx-4 px-4 md:-mx-8 md:px-8 bg-text_color text-background_color" data-v-e82120d2${_scopeId}>Billing</h3><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-e82120d2${_scopeId}><div class="md:col-span-2" data-v-e82120d2${_scopeId}><label for="email-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>E-mail</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="email-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
            ...
            _push2(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-e82120d2${_scopeId}><div data-v-e82120d2${_scopeId}><label for="firstName-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Name</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="firstName-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div><div data-v-e82120d2${_scopeId}><label for="lastName-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Surname</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              id: "lastName-desktop",
              name: "lastName",
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="lastName-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-e82120d2${_scopeId}><div class="md:col-span-2" data-v-e82120d2${_scopeId}><label for="address-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Address</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              id: "address-desktop",
              name: "address",
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="address-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-e82120d2${_scopeId}><div data-v-e82120d2${_scopeId}><label for="postal_code-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Post code</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="postal_code-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div><div data-v-e82120d2${_scopeId}><label for="city-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Town / City</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              id: "city-desktop",
              name: "city",
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="city-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div></div><div class="grid grid-cols-1 gap-6" data-v-e82120d2${_scopeId}><div data-v-e82120d2${_scopeId}><label for="country-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Country / Region</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              id: "country-desktop",
              name: "country",
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><option value="" data-v-e82120d2${_scopeId2}>Select country</option><option value="Croatia" data-v-e82120d2${_scopeId2}>Croatia</option><option value="Slovenia" data-v-e82120d2${_scopeId2}>Slovenia</option><option value="Austria" data-v-e82120d2${_scopeId2}>Austria</option><option value="Germany" data-v-e82120d2${_scopeId2}>Germany</option><option value="Italy" data-v-e82120d2${_scopeId2}>Italy</option></select><div id="country-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div><div data-v-e82120d2${_scopeId}><label for="phone_number-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Telephone</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="phone_number-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div></div></div><div class="space-y-8 mt-10" data-v-e82120d2${_scopeId}><h3 class="text-base uppercase tracking-widest py-2 -mx-4 px-4 md:-mx-8 md:px-8 bg-text_color text-background_color" data-v-e82120d2${_scopeId}>Delivery</h3><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-e82120d2${_scopeId}><div class="md:col-span-2" data-v-e82120d2${_scopeId}><label for="delivery_address-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Delivery Address</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="delivery_address-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-e82120d2${_scopeId}><div data-v-e82120d2${_scopeId}><label for="delivery_postal_code-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Delivery Post code</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="delivery_postal_code-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div><div data-v-e82120d2${_scopeId}><label for="delivery_city-desktop" class="block text-xs uppercase tracking-widest mb-2" data-v-e82120d2${_scopeId}>Delivery City</label>`);
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field, errorMessage }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }))} data-v-e82120d2${_scopeId2}><div id="delivery_city-error-desktop" class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId2}>`);
                  if (errorMessage) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(errorMessage)}</p>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(`</div></div></div><div class="space-y-6 mt-10" data-v-e82120d2${_scopeId}><h3 class="text-base uppercase tracking-widest py-2 -mx-4 px-4 md:-mx-8 md:px-8 bg-text_color text-background_color" data-v-e82120d2${_scopeId}>Payment</h3><div class="flex flex-col md:flex-row gap-3" data-v-e82120d2${_scopeId}><label class="flex-1 cursor-pointer" data-v-e82120d2${_scopeId}><input type="radio" name="payment" value="card" class="sr-only peer" data-v-e82120d2${_scopeId}><div class="${ssrRenderClass([unref(selectedPaymentMethod) === "card" ? "border-text_color bg-text_color/5 font-medium" : "border-text_color/30", "px-4 py-3 border text-sm uppercase transition-colors flex items-center gap-2 peer-checked:border-text_color peer-checked:bg-text_color/50 peer-checked:font-medium peer-checked:text-background_color hover:border-text_color/50"])}" data-v-e82120d2${_scopeId}><img${ssrRenderAttr("src", _imports_0)} alt="Card Payment" class="w-5 h-5 object-contain" data-v-e82120d2${_scopeId}><span data-v-e82120d2${_scopeId}>Card</span></div></label><label class="flex-1 cursor-pointer" data-v-e82120d2${_scopeId}><input type="radio" name="payment" value="paypal" class="sr-only peer" data-v-e82120d2${_scopeId}><div class="${ssrRenderClass([unref(selectedPaymentMethod) === "paypal" ? "border-text_color bg-text_color/5 font-medium" : "border-text_color/30", "px-4 py-3 border text-sm uppercase transition-colors flex items-center gap-2 peer-checked:border-text_color peer-checked:bg-text_color/50 peer-checked:font-medium peer-checked:text-background_color hover:border-text_color/50"])}" data-v-e82120d2${_scopeId}><img${ssrRenderAttr("src", _imports_1)} alt="PayPal" class="w-5 h-5 object-contain" data-v-e82120d2${_scopeId}><span data-v-e82120d2${_scopeId}>PayPal</span></div></label></div><div class="space-y-4 pt-2" data-v-e82120d2${_scopeId}><label class="flex items-start gap-3 text-sm cursor-pointer" data-v-e82120d2${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Field), {
              name: "newsletter",
              type: "checkbox",
              value: true,
            ...
            _push2(`<span data-v-e82120d2${_scopeId}>I want to receive personalised commercial communications by email.</span></label><label class="flex items-start gap-3 text-sm cursor-pointer" data-v-e82120d2${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Field), {
            ...
            _push2(`<span data-v-e82120d2${_scopeId}><a href="#" class="underline hover:no-underline" data-v-e82120d2${_scopeId}>I have read and understand the Privacy and Cookies Policy.</a></span></label><div class="mt-1 h-4 overflow-hidden" data-v-e82120d2${_scopeId}>`);
            _push2(ssrRenderComponent(unref(ErrorMessage), { name: "privacyAccepted" }, {
              default: withCtx(({ message }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(``);
                  if (message) {
                    _push3(`<p class="text-xs text-error_text_color leading-4" data-v-e82120d2${_scopeId2}>${ssrInterpolate(message)}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(`</div></div></div><div class="pt-6" data-v-e82120d2${_scopeId}><button type="submit" class="${ssrRenderClass([unref(isSubmitDisabled) ? "btn--disabled" : "btn--primary", "w-full btn"])}"${ssrIncludeBooleanAttr(unref(isSubmitDisabled)) ? " disabled" : ""} data-v-e82120d2${_scopeId}><span class="btn__text" data-v-e82120d2${_scopeId}>${ssrInterpolate(unref(submitting) ? "Placing Order…" : "Place Order")}</span><span class="btn__fill" data-v-e82120d2${_scopeId}></span></button><div class="mt-3 h-5 overflow-hidden" data-v-e82120d2${_scopeId}>`);
            if (unref(errorMsg)) {
              _push2(`<p class="text-sm text-error_text_color" data-v-e82120d2${_scopeId}>${ssrInterpolate(unref(errorMsg))}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
      ...
      _push(`<aside class="w-full mt-10 md:mt-0" data-v-e82120d2><div class="space-y-5" data-v-e82120d2><h2 class="uppercase tracking-widest text-sm" data-v-e82120d2>Order Summary</h2>`);
      if (unref(cart).items.length) {
        _push(`<div class="grid grid-cols-1 gap-y-4" data-v-e82120d2><!--[-->`);
        ssrRenderList(unref(cart).items, (item, idx) => {
          _push(`<div class="flex gap-4" data-v-e82120d2><img${ssrRenderAttr("src", item.avatar_image)}${ssrRenderAttr("alt", item.product)} class="w-22 h-40 object-cover border" loading="lazy" data-v-e82120d2><div class="flex-1" data-v-e82120d2><div class="text-sm md:text-base leading-tight tracking-wider px-3" data-v-e82120d2>${ssrInterpolate(item.product)}</div><div class="text-xs mt-1 tracking-wider px-3" data-v-e82120d2>Size: ${ssrInterpolate(item.size)}</div><div class="text-xs mt-1 tracking-wider px-3" data-v-e82120d2>Quantity: ${ssrInterpolate(item.quantity)}</div></div><div class="text-right" data-v-e82120d2><div class="text-sm md:text-base" data-v-e82120d2>`);
          if (item.unit_price_discounted !== item.unit_price_original) {
            _push(`<span class="space-x-1" data-v-e82120d2><span class="font-semibold" data-v-e82120d2>€${ssrInterpolate(item.unit_price_discounted)}</span><span class="line-through text-xs" data-v-e82120d2>€${ssrInterpolate(item.unit_price_original)}</span></span>`);
          } else {
            _push(`<span data-v-e82120d2>€${ssrInterpolate(item.unit_price_original)}</span>`);
          }
          _push(`</div><button type="button" class="mt-3 text-xs uppercase tracking-widest border-b border-text_color/30 hover:border-text_color transition-colors disabled:opacity-50"${ssrIncludeBooleanAttr(unref(removingSlug) === getItemSlug(item)) ? " disabled" : ""} data-v-e82120d2>${ssrInterpolate(unref(removingSlug) === getItemSlug(item) ? "Removing..." : "Remove item")}</button></div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<div class="text-sm opacity-70" data-v-e82120d2>Your cart is empty.</div>`);
      }
      _push(`<div class="space-y-2 text-sm border-t border-text_color/30 pt-4" data-v-e82120d2><div class="flex justify-between" data-v-e82120d2><span data-v-e82120d2>Subtotal</span><span data-v-e82120d2>€${ssrInterpolate(formatMoney(unref(subtotal)))}</span></div><div class="flex justify-between" data-v-e82120d2><span data-v-e82120d2>Shipping</span>`);
      if (unref(shippingFee) === 0) {
        _push(`<span data-v-e82120d2>€0 (Free)</span>`);
      } else {
        _push(`<span data-v-e82120d2>€${ssrInterpolate(formatMoney(unref(shippingFee)))}</span>`);
      }
      _push(`</div><div class="flex justify-between font-medium text-base pt-2" data-v-e82120d2><span data-v-e82120d2>Total</span><span data-v-e82120d2>€${ssrInterpolate(formatMoney(unref(total)))}</span></div><p class="text-xs opacity-70" data-v-e82120d2> Prices include VAT, excluding any import duties. </p></div></div></aside></div><div class="md:hidden pb-10 max-w-screen-md mx-auto px-4 md:px-8 pt-4 gap-6" data-v-e82120d2><div class="border-t border-b border-text_color/30 bg-background_color text-text_color rounded-sm" data-v-e82120d2><div class="flex items-center justify-between py-4" data-v-e82120d2><div class="text-sm uppercase tracking-widest" data-v-e82120d2> Cart (${ssrInterpolate(unref(cart).items.length)}) </div><div class="text-base font-medium" data-v-e82120d2> €${ssrInterpolate(formatMoney(unref(total)))}</div></div><div class="pb-4 text-sm space-y-1" data-v-e82120d2><div class="flex justify-between" data-v-e82120d2><span data-v-e82120d2>Subtotal</span><span data-v-e82120d2>€${ssrInterpolate(formatMoney(unref(subtotal)))}</span></div><div class="flex justify-between" data-v-e82120d2><span data-v-e82120d2>Shipping</span>`);
      if (unref(shippingFee) === 0) {
        _push(`<span data-v-e82120d2>€0 (Free)</span>`);
      } else {
        _push(`<span data-v-e82120d2>€${ssrInterpolate(formatMoney(unref(shippingFee)))}</span>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(PopoverButton), { class: "w-full flex items-center justify-between py-4 text-sm border-t border-text_color/20" }, {
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="uppercase tracking-widest" data-v-e82120d2${_scopeId2}> Items (${ssrInterpolate(unref(cart).items.length)}) </span>`);
            ...
            _push2(ssrRenderComponent(unref(PopoverPanel), {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="max-h-80 overflow-y-auto divide-y divide-text_color/30" data-v-e82120d2${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(cart).items, (item, idx) => {
                    _push3(`<div class="flex gap-3 py-3" data-v-e82120d2${_scopeId2}><img${ssrRenderAttr("src", item.avatar_image)}${ssrRenderAttr("alt", item.product)} class="w-20 h-24 object-cover border" loading="lazy" data-v-e82120d2${_scopeId2}><div class="flex-1 min-w-0" data-v-e82120d2${_scopeId2}><div class="text-sm leading-tight line-clamp-2" data-v-e82120d2${_scopeId2}>${ssrInterpolate(item.product)}</div><div class="mt-1 text-xs opacity-70" data-v-e82120d2${_scopeId2}>Size: ${ssrInterpolate(item.size)}</div><div class="mt-1 text-xs opacity-70" data-v-e82120d2${_scopeId2}>Qty: ${ssrInterpolate(item.quantity)}</div><div class="mt-2 text-sm" data-v-e82120d2${_scopeId2}>`);
                    if (item.unit_price_discounted !== item.unit_price_original) {
                      _push3(`<span class="space-x-1" data-v-e82120d2${_scopeId2}><span class="font-medium" data-v-e82120d2${_scopeId2}>€${ssrInterpolate(item.unit_price_discounted)}</span><span class="line-through text-xs" data-v-e82120d2${_scopeId2}>€${ssrInterpolate(item.unit_price_original)}</span></span>`);
                    } else {
                      _push3(`<span data-v-e82120d2${_scopeId2}>€${ssrInterpolate(item.unit_price_original)}</span>`);
                    }
                    _push3(`</div></div><button type="button" class="shrink-0 p-1 hover:bg-text_color/10 rounded-sm h-7 transition-colors disabled:opacity-50"${ssrIncludeBooleanAttr(unref(removingSlug) === getItemSlug(item)) ? " disabled" : ""}${ssrRenderAttr("aria-label", `Remove ${item.product}`)} title="Remove" data-v-e82120d2${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_Icon, {
                      name: "lucide:x",
                      class: "w-4 h-4"
                    }, null, _parent3, _scopeId2));
      ...
      _push(ssrRenderComponent(unref(Form), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div></div><div class="space-y-6 mt-10" data-v-e82120d2${_scopeId}><h3 class="text-base uppercase tracking-widest py-2 -mx-4 px-4 md:-mx-8 md:px-8 bg-text_color text-background_color" data-v-e82120d2${_scopeId}>Payment</h3><div class="flex flex-col md:flex-row gap-3" data-v-e82120d2${_scopeId}><label class="flex-1 justify-center items-center cursor-pointer" data-v-e82120d2${_scopeId}><input type="radio" name="payment" value="card" class="sr-only peer" data-v-e82120d2${_scopeId}><div class="${ssrRenderClass([unref(selectedPaymentMethod) === "card" ? "border-text_color bg-text_color/5 font-medium" : "border-text_color/30", "px-4 py-3 border text-sm mx-auto uppercase transition-colors flex justify-center items-center gap-2 peer-checked:border-text_color peer-checked:bg-text_color/50 peer-checked:font-medium peer-checked:text-background_color hover:border-text_color/50"])}" data-v-e82120d2${_scopeId}><img${ssrRenderAttr("src", _imports_0)} alt="Card Payment" class="w-5 h-5 object-contain" data-v-e82120d2${_scopeId}><span data-v-e82120d2${_scopeId}>Card</span></div></label><label class="flex-1 justify-center items-center cursor-pointer" data-v-e82120d2${_scopeId}><input type="radio" name="payment" value="paypal" class="sr-only peer" data-v-e82120d2${_scopeId}><div class="${ssrRenderClass([unref(selectedPaymentMethod) === "paypal" ? "border-text_color bg-text_color/5 font-medium" : "border-text_color/30", "px-4 py-3 border text-sm mx-auto uppercase transition-colors flex justify-center items-center gap-2 peer-checked:border-text_color peer-checked:bg-text_color/50 peer-checked:font-medium peer-checked:text-background_color hover:border-text_color/50"])}" data-v-e82120d2${_scopeId}><img${ssrRenderAttr("src", _imports_1)} alt="PayPal" class="w-5 h-5 object-contain" data-v-e82120d2${_scopeId}><span data-v-e82120d2${_scopeId}>PayPal</span></div></label></div><div class="space-y-4 pt-2" data-v-e82120d2${_scopeId}><label class="flex items-start gap-3 text-sm cursor-pointer" data-v-e82120d2${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Field), {
              name: "newsletter",
              type: "checkbox",
              value: true,
...
const checkout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e82120d2"]]);
export {
  checkout as default
};
//# sourceMappingURL=checkout-BI3hUnas.js.map
