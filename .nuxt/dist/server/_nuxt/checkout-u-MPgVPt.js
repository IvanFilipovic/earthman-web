...
import { _ as _export_sfc, q as useCookie, n as navigateTo } from "../server.mjs";
    ...
    async function handleSubmit() {
      ...
      try {
        ...
        if (response.payment_method === "card") {
          ...
          const paypalData = await $fetch("/api/payment/initialize", {
            method: "POST",
            body: { payment_id: response.payment_id }
          });
          (void 0).location.href = `${paypalData.approval_url}&payment_session_id=${response.payment_id}`;
        }
      } catch (error) {
...
//# sourceMappingURL=checkout-u-MPgVPt.js.map
