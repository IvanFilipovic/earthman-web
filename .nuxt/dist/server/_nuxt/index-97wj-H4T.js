...
import { _ as __nuxt_component_0 } from "./index-Ccr6sSLn.js";
...
/* empty css                         */
import { b as useRouter, c as useRoute, _ as _export_sfc, d as __nuxt_component_4, e as useRuntimeConfig } from "../server.mjs";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid grid-cols-2 md:grid-cols-4 overflow-y-auto pt-8 gap-x-4 md:gap-x-8 lg:gap-x-24" }, _attrs))} data-v-53d70bb8><!--[-->`);
      ssrRenderList(__props.products, (item) => {
        _push(`<div class="col-span-1 cursor-pointer pb-10" data-v-53d70bb8><div class="bg-background_color overflow-hidden object-fill" data-v-53d70bb8><div class="w-full" data-v-53d70bb8><div class="relative bg-background_color" data-v-53d70bb8><img${ssrRenderAttr("src", getMainImage(item))}${ssrRenderAttr("alt", item.alt_text || item.name)} class="hidden md:block max-w-[100%] h-auto object-cover transition-opacity duration-200 border border-text_color/30" loading="lazy" data-v-53d70bb8>`);
        if (item.colors && item.colors.length > 0) {
          _push(`<div class="block md:hidden" data-v-53d70bb8><div class="keen-slider" data-v-53d70bb8><!--[-->`);
          ssrRenderList(item.colors, (color, i) => {
            _push(`<div class="keen-slider__slide" data-v-53d70bb8><img${ssrRenderAttr("src", color.avatar_image)}${ssrRenderAttr("alt", color.color)} class="w-full h-auto object-cover border border-text_color/30" loading="lazy" data-v-53d70bb8></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button type="button" class="${ssrRenderClass([{ "opacity-100": unref(hoveredSlug) === item.slug }, "absolute top-4 left-4 bg-text_color text-background_color tracking-wider text-xs font-light w-auto px-2 mx-auto opacity-0 transition-opacity duration-200"])}" style="${ssrRenderStyle(unref(hoveredSlug) === item.slug ? null : { display: "none" })}" data-v-53d70bb8> VIEW </button></div><div class="py-3 text-left" data-v-53d70bb8><p class="text-xs tracking-wider font-extralight" data-v-53d70bb8>${ssrInterpolate(item.category)}</p><h3 class="uppercase tracking-wider text-[13px] md:text-sm font-normal truncate py-1" data-v-53d70bb8>${ssrInterpolate(item.name)}</h3>`);
        if (item.colors && item.colors.length > 0) {
          _push(`<div class="mt-1 flex items-center gap-2" data-v-53d70bb8><!--[-->`);
          ssrRenderList(item.colors, (color, colorIdx) => {
            _push(`<div class="relative group" data-v-53d70bb8><img${ssrRenderAttr("src", color.avatar_image)}${ssrRenderAttr("alt", color.color)} class="w-7 h-7 md:h-8 md:w-8 object-cover border border-project_black/40 cursor-pointer" loading="lazy" data-v-53d70bb8><div class="${ssrRenderClass([isColorHovered(item, colorIdx) ? "opacity-100" : "opacity-0", "absolute inset-0 pointer-events-none transition-opacity duration-200 w-8 h-8 bg-text_color"])}" data-v-53d70bb8>`);
        ...
        _push(`<p class="mt-1 text-xs font-light" data-v-53d70bb8>€${ssrInterpolate(formatPrice(item.price))}</p></div></div></div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-53d70bb8"]]);
const PAGE_SIZE = 12;
...
//# sourceMappingURL=index-97wj-H4T.js.map
