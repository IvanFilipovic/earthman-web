import { defineComponent, mergeProps, useSSRContext, unref, withCtx, createTextVNode, computed, useAttrs, ref, createVNode } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrRenderSlot, ssrRenderSuspense, ssrRenderList, ssrRenderStyle, ssrInterpolate, ssrRenderComponent } from "vue/server-renderer";
import { _ as _export_sfc, e as useRequestEvent, w as withLeadingSlash, h as hasProtocol, j as joinURL, p as parseURL, f as encodeParam, g as encodePath, i as useNuxtApp, k as useRuntimeConfig, u as useHead } from "../server.mjs";
import { u as useFetch, _ as __nuxt_component_0$2 } from "./AppHeader-DUh5dxmB.js";
import { _ as __nuxt_component_0$1 } from "./nuxt-link-CdcgahCt.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderSuspense(_push, {
        default: () => {
          _push(`<div class="grid grid-cols-2 w-full h-auto lg:h-screen overflow-hidden" data-v-2cb14520><!--[-->`);
          ssrRenderList(unref(collections), (collection) => {
            _push(`<div class="relative w-full pt-[100%] bg-cover bg-center overflow-hidden" style="${ssrRenderStyle({ backgroundImage: `url(${collection.element_one_image})` })}" data-v-2cb14520><div class="overlay absolute top-0 left-0 right-0 text-text_color flex flex-col justify-end h-full hover:bg-background_color" data-v-2cb14520><div class="flex flex-col space-y-2 p-4 self-end" data-v-2cb14520><h2 class="mb-2 text-2xl font-bold self-end bg-background_color/60 px-2" data-v-2cb14520>${ssrInterpolate(collection.name)}</h2>`);
        ...
        fallback: () => {
          _push(`<div class="flex items-center justify-center h-screen" data-v-2cb14520> Loading collections… </div>`);
        },
        _: 1
      });
    };
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-2cb14520"]]);
...
//# sourceMappingURL=index-B69m579l.js.map
