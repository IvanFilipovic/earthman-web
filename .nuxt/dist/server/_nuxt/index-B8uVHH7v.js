import { defineComponent, ref, mergeProps, useSSRContext, withAsyncContext, unref, withCtx, createVNode, computed, useAttrs } from "vue";
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "smooth-wrapper" }, _attrs))} data-v-c6625c25>`);
      if (unref(loading)) {
        _push(`<div class="fixed inset-0 flex items-center justify-center bg-background_color" data-v-c6625c25><p class="text-text_color text-xl" data-v-c6625c25>Loading collections...</p></div>`);
      } else {
        _push(`<div id="smooth-content" class="stage" data-v-c6625c25><!--[-->`);
        ssrRenderList(unref(collections), (collection, i) => {
          _push(`<section class="slide" data-v-c6625c25><div class="col col--1" data-v-c6625c25><div class="${ssrRenderClass([`col__content--${getColorVariant(i)}`, "col__content"])}" data-v-c6625c25><h2 class="${ssrRenderClass(`col__content-title--${getColorVariant(i)}`)}" data-v-c6625c25><span class="line__inner" data-v-c6625c25>${ssrInterpolate(collection.name || "Collection")}</span></h2><div class="col__content-wrap" data-v-c6625c25>`);
          if (collection.slug) {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<span class="btn__text" data-v-c6625c25${_scopeId}>View Story</span><span class="btn__fill" data-v-c6625c25${_scopeId}></span>`);
                } else {
                  return [
          ...
          _push(`</div></div></div><div class="col col--2" data-v-c6625c25><div class="col__image-wrap" data-v-c6625c25><img class="img"${ssrRenderAttr("src", collection.element_one_image)}${ssrRenderAttr("alt", collection.name || `Collection ${i + 1}`)} loading="lazy" decoding="async" data-v-c6625c25></div></div></section>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c6625c25"]]);
  ...
  _push(ssrRenderComponent(_component_BackgroundVideo, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</div><div class="absolute inset-x-0 bottom-[50px] md:bottom-0 left-0 flex items-center flex-col pb-8 text-background_color px-4 md:text-end md:self-end"${_scopeId}><h1 class="text-4xl md:text-6xl font-bold mb-4 self-center text-center md:self-end"${_scopeId}> Welcome to Our Shop </h1><p class="md:self-end mb-8 self-center text-center"${_scopeId}> Explore our latest collection with immersive video background. </p>`);
        ...
        return [
          ...
          createVNode("div", { class: "absolute inset-x-0 bottom-[50px] md:bottom-0 left-0 flex items-center flex-col pb-8 text-background_color px-4 md:text-end md:self-end" }, [
...
//# sourceMappingURL=index-B8uVHH7v.js.map
