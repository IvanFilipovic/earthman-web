...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "collections-page" }, _attrs))} data-v-2e72a592><div class="fixed top-0 left-0 w-full z-50" data-v-2e72a592>`);
      _push(ssrRenderComponent(_component_AppNavigation, { dark: unref(isDark) }, null, _parent));
      _push(`</div>`);
      if (unref(loading)) {
        _push(`<div class="fixed inset-0 flex items-center justify-center bg-background_color z-40" data-v-2e72a592><p class="text-text_color text-xl" data-v-2e72a592>Loading collections...</p></div>`);
      } else {
        _push(`<div id="smooth-wrapper" data-v-2e72a592><div id="smooth-content" data-v-2e72a592><!--[-->`);
        ssrRenderList(unref(collections), (collection, i) => {
          _push(`<section class="${ssrRenderClass([`slide--${i % 2 + 1}`, "slide"])}" data-v-2e72a592><div class="slide__bg" style="${ssrRenderStyle({ backgroundImage: `url(${collection.element_one_image})` })}" data-v-2e72a592><div class="slide__overlay" data-v-2e72a592></div></div><div class="slide__content" data-v-2e72a592><div class="slide__content-inner" data-v-2e72a592><h2 class="slide__title" data-v-2e72a592><span class="slide__title-line" data-v-2e72a592><span class="line__inner" data-v-2e72a592>${ssrInterpolate(collection.name)}</span></span></h2><div class="slide__cta" data-v-2e72a592>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="btn__text" data-v-2e72a592${_scopeId}>View Story</span><span class="btn__fill" data-v-2e72a592${_scopeId}></span>`);
              } else {
                return [
          ...
          if (i < unref(collections).length - 1) {
            _push(`<button type="button" class="slide__scroll-btn" data-v-2e72a592><span class="slide__scroll-line" data-v-2e72a592></span>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2e72a592"]]);
export {
  index as default
};
//# sourceMappingURL=index-BqlLwbne.js.map
