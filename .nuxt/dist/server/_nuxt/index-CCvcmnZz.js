import { defineComponent, mergeProps, useSSRContext, ref, watch, computed } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderStyle, ssrRenderAttr, ssrRenderComponent, ssrRenderClass, ssrInterpolate } from "vue/server-renderer";
import { _ as _sfc_main$3 } from "./MobileColorSlider-DLe-Ur6a.js";
import { c as __nuxt_component_0, d as useRouter$1, e as useRoute, f as __nuxt_component_1, g as useRuntimeConfig, _ as _export_sfc } from "../server.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.count, (i) => {
        _push(`<div class="col-span-1 pb-10 animate-pulse"><div class="overflow-hidden"><div class="w-full border" style="${ssrRenderStyle(skeletonStyle)}"><div class="w-full h-[255.73] md:h-[407.35px] lg:h-[568.723px] aspect-[3/4]" style="${ssrRenderStyle(skeletonStyle)}"></div></div></div><div class="py-3"><div class="h-3 w-24" style="${ssrRenderStyle(skeletonStyle)}"></div><div class="mt-2 h-4 w-3/4" style="${ssrRenderStyle(skeletonStyle)}"></div><div class="mt-3 flex items-center gap-2"><div class="w-7 h-7 md:w-8 md:h-8 rounded" style="${ssrRenderStyle(skeletonStyle)}"></div><div class="w-7 h-7 md:w-8 md:h-8 rounded" style="${ssrRenderStyle(skeletonStyle)}"></div></div><div class="mt-3 h-4 w-16" style="${ssrRenderStyle(skeletonStyle)}"></div></div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-1208233a>`);
      _push(ssrRenderComponent(__nuxt_component_0$1, { dark: false }, null, _parent));
      _push(`<div class="flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 pt-4 gap-6" data-v-1208233a><div class="flex justify-between w-full" data-v-1208233a><div class="flex items-center" data-v-1208233a><button class="${ssrRenderClass(genderBtnClass("female"))}" data-v-1208233a>WOMAN</button><button class="${ssrRenderClass(genderBtnClass("male"))}" data-v-1208233a>MAN</button></div><div class="flex gap-3 justify-end w-full" data-v-1208233a><div class="flex items-center gap-3" data-v-1208233a><span class="uppercase text-xs tracking-widest ml-4" data-v-1208233a>Page</span><!--[-->`);
      ssrRenderList(totalPages.value, (p) => {
        _push(`<button class="${ssrRenderClass([p === page.value ? "underline" : "opacity-60", "text-sm uppercase tracking-widest"])}" data-v-1208233a>${ssrInterpolate(p)}</button>`);
      });
      _push(`<!--]--><button class="text-md uppercase tracking-widest" data-v-1208233a>Filters</button></div></div></div></div>`);
      if (loading.value) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1208233a"]]);
export {
  index as default
};
//# sourceMappingURL=index-CCvcmnZz.js.map
