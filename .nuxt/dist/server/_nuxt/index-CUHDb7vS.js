import { _ as __nuxt_component_0$2 } from "./AppNavigation-DbbUjllq.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function getHeroImageAttrs(url) {
      return getResponsiveImages(
        url,
        [800, 1200, 1920, 2560],
        // Full-width hero: mobile to 4K
        "100vw"
        // Always full viewport width
      );
    }
    function getSectionImageAttrs(url) {
      const mainWidth = 1600;
      return getResponsiveImages(
        url,
        [mainWidth],
        // Mobile to desktop retina
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-6a51fc07>`);
      _push(ssrRenderComponent(_component_AppNavigation, { dark: unref(isDark) }, null, _parent));
      _push(`<div id="smooth-wrapper" data-v-6a51fc07><div id="smooth-content" data-v-6a51fc07><div class="min-h-screen" data-v-6a51fc07><div class="relative pt-8 px-4 md:px-8" data-v-6a51fc07><div class="hero-section relative w-full h-[70vh] border border-text_color/30 overflow-hidden" data-v-6a51fc07><img${ssrRenderAttrs(mergeProps(getHeroImageAttrs(heroImage), {
        alt: "Material study",
        class: "absolute inset-0 w-full h-full object-cover"
      }))} data-v-6a51fc07><div class="absolute inset-0 bg-text_color/30" data-v-6a51fc07></div><div class="absolute inset-0 flex items-end" data-v-6a51fc07><div class="hero-content p-8 md:p-12 text-background_color mx-auto" data-v-6a51fc07><h3 class="hero-title text-2xl md:text-4xl text-center mb-3 bg-text_color px-4 py-2" data-v-6a51fc07> Materials, Mastered </h3><p class="hero-text max-w-lg text-sm md:text-base text-center bg-text_color py-2 px-4" data-v-6a51fc07> From recycled cotton to traceable leathers—our platform partners with mills that publish their practices and certify their fibers. </p></div></div></div></div></div><div class="section-light min-h-screen pb-20" data-v-6a51fc07><div class="flex flex-col lg:flex-row gap-10 items-start px-4 md:px-8 pb-14 md:py-0" data-v-6a51fc07><div class="w-full lg:w-1/2 my-auto pb-10" data-v-6a51fc07><img${ssrRenderAttrs(mergeProps(getSectionImageAttrs(section1Image), {
        alt: "Studio story",
        class: "section-image w-full h-[70vh] object-cover border border-text_color/30",
        loading: "lazy"
      }))} data-v-6a51fc07></div><div class="w-full lg:w-1/2 flex flex-col my-auto pt-10" data-v-6a51fc07><h2 class="section-title text-2xl md:text-3xl tracking-wide mb-4 mx-auto uppercase" data-v-6a51fc07> Crafted with Intent </h2><p class="section-text text-sm md:text-base leading-normal md:leading-loose text-center mx-auto px-4 py-2" data-v-6a51fc07> We design for longevity: timeless silhouettes, resilient materials, and a supply chain we&#39;re proud of. Every piece is cut in small batches and finished by hand. Our studio blends traditional techniques with forward-looking processes—prioritizing responsible sourcing and modular construction so garments can be repaired, re-worn, and re-loved. </p></div></div></div><div class="section-dark min-h-screen" data-v-6a51fc07><div class="flex flex-col lg:flex-row-reverse gap-10 items-start px-4 md:px-8 min-h-screen" data-v-6a51fc07><div class="w-full lg:w-1/2 my-auto" data-v-6a51fc07><img${ssrRenderAttrs(mergeProps(getSectionImageAttrs(section2Image), {
        alt: "Community story",
        class: "section-image w-full h-[70vh] object-cover border border-background_color/30",
        loading: "lazy"
      }))} data-v-6a51fc07></div><div class="w-full lg:w-1/2 flex flex-col my-auto" data-v-6a51fc07><h2 class="section-title text-2xl md:text-3xl tracking-wide mb-4 mx-auto uppercase" data-v-6a51fc07> Community Driven </h2><p class="section-text text-sm md:text-base leading-normal md:leading-loose text-center mx-auto px-4 py-2" data-v-6a51fc07> We design for longevity: timeless silhouettes, resilient materials, and a supply chain we&#39;re proud of. Every piece is cut in small batches and finished by hand. Our studio blends traditional techniques with forward-looking processes—prioritizing responsible sourcing and modular construction so garments can be repaired, re-worn, and re-loved. </p></div></div></div><div data-v-6a51fc07><div data-v-6a51fc07><div class="hidden lg:block" data-v-6a51fc07>`);
      _push(ssrRenderComponent(_component_InstagramGrid, {
        posts,
        initial: 5,
        step: 6
      }, null, _parent));
      _push(`</div><div class="lg:hidden block" data-v-6a51fc07>`);
      _push(ssrRenderComponent(_component_InstagramGrid, {
        posts,
        initial: 3,
        step: 6
      }, null, _parent));
      _push(`</div></div></div></div></div><div class="earth-scroll" data-v-6a51fc07></div></section>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6a51fc07"]]);
export {
  index as default
};
//# sourceMappingURL=index-CUHDb7vS.js.map
