...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "collections-page" }, _attrs))} data-v-d56a53c3><div class="fixed top-0 left-0 w-full z-50" data-v-d56a53c3>`);
      _push(ssrRenderComponent(_component_AppNavigation, { dark: true }, null, _parent));
      _push(`</div>`);
      if (unref(loading)) {
        _push(`<div class="fixed inset-0 flex items-center justify-center bg-background_color z-40" data-v-d56a53c3><p class="text-text_color text-xl" data-v-d56a53c3>Loading collections...</p></div>`);
      } else {
        _push(`<div id="smooth-wrapper" data-v-d56a53c3><div id="smooth-content" data-v-d56a53c3><!--[-->`);
        ssrRenderList(unref(collections), (collection, i) => {
          _push(`<section class="${ssrRenderClass([`slide--${i % 2 + 1}`, "slide"])}" data-v-d56a53c3><div class="slide__bg" style="${ssrRenderStyle({ backgroundImage: `url(${collection.element_one_image})` })}" data-v-d56a53c3><div class="slide__overlay" data-v-d56a53c3></div></div><div class="slide__content" data-v-d56a53c3><div class="slide__content-inner" data-v-d56a53c3><h2 class="slide__title" data-v-d56a53c3><span class="slide__title-line" data-v-d56a53c3><span class="line__inner" data-v-d56a53c3>${ssrInterpolate(collection.name)}</span></span></h2><div class="slide__cta" data-v-d56a53c3>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="btn__text" data-v-d56a53c3${_scopeId}>View Story</span><span class="btn__fill" data-v-d56a53c3${_scopeId}></span>`);
              } else {
                return [
          ...
          if (i < unref(collections).length - 1) {
            _push(`<button type="button" class="slide__scroll-btn" data-v-d56a53c3><span class="slide__scroll-line" data-v-d56a53c3></span>`);
            ...
            _push(`<button type="button" class="slide__scroll-btn" data-v-d56a53c3>`);
            _push(ssrRenderComponent(_component_Icon, {
              name: "lucide:chevron-up",
              class: "slide__scroll-icon"
            }, null, _parent));
            _push(`<span class="slide__scroll-line" data-v-d56a53c3></span></button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></section>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d56a53c3"]]);
export {
  index as default
};
//# sourceMappingURL=index-CUsZ1GIv.js.map
