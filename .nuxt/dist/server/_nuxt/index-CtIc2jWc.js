...
import { _ as _export_sfc, b as useRouter, f as useRequestEvent, w as withLeadingSlash, h as hasProtocol, j as joinURL, p as parseURL, g as encodeParam, i as encodePath, k as useNuxtApp, e as useRuntimeConfig, u as useHead } from "../server.mjs";
/* empty css                         */
import "keen-slider";
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "smooth-wrapper" }, _attrs))} data-v-f16274dc>`);
      if (unref(loading)) {
        _push(`<div class="fixed inset-0 flex items-center justify-center bg-background_color" data-v-f16274dc><p class="text-text_color text-xl" data-v-f16274dc>Loading collections...</p></div>`);
      } else {
        _push(`<div id="smooth-content" class="stage" data-v-f16274dc><!--[-->`);
        ssrRenderList(unref(collections), (collection, i) => {
          _push(`<section class="slide" data-v-f16274dc><div class="col col--1" data-v-f16274dc><div class="${ssrRenderClass([`col__content--${getColorVariant(i)}`, "col__content"])}" data-v-f16274dc><h2 class="${ssrRenderClass(`col__content-title--${getColorVariant(i)}`)}" data-v-f16274dc><span class="line__inner" data-v-f16274dc>${ssrInterpolate(collection.name || "Collection")}</span></h2><div class="col__content-wrap" data-v-f16274dc>`);
          if (collection.slug) {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<span class="btn__text" data-v-f16274dc${_scopeId}>${ssrInterpolate(_ctx.$t("story_button"))}</span><span class="btn__fill" data-v-f16274dc${_scopeId}></span>`);
                } else {
                  return [
          ...
          _push(`</div></div></div><div class="col col--2" data-v-f16274dc><div class="col__image-wrap" data-v-f16274dc><img class="img"${ssrRenderAttr("src", collection.element_one_image)}${ssrRenderAttr("alt", collection.name || `Collection ${i + 1}`)} loading="lazy" decoding="async" data-v-f16274dc></div></div></section>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f16274dc"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))} data-v-d5e60a20>`);
  _push(ssrRenderComponent(_component_BackgroundVideo, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="absolute inset-x-0 top-0 w-full z-50" data-v-d5e60a20${_scopeId}>`);
        _push2(ssrRenderComponent(_component_AppNavigation, { dark: true }, null, _parent2, _scopeId));
        _push2(`</div><div class="min-h-screen flex flex-col justify-end items-center md:items-end px-4 md:px-8 pb-12 md:pb-16 z-40 w-full" data-v-d5e60a20${_scopeId}><div class="text-background_color text-center md:text-right max-w-2xl" data-v-d5e60a20${_scopeId}><h1 class="text-4xl md:text-6xl font-bold mb-4" data-v-d5e60a20${_scopeId}>${ssrInterpolate(_ctx.$t("welcome_title"))}</h1><p class="mb-8 text-base md:text-lg" data-v-d5e60a20${_scopeId}>${ssrInterpolate(_ctx.$t("welcome_subtitle"))}</p>`);
        _push2(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<span class="btn__text" data-v-d5e60a20${_scopeId2}>${ssrInterpolate(_ctx.$t("shop_button"))}</span><span class="btn__fill" data-v-d5e60a20${_scopeId2}></span>`);
            } else {
              return [
        ...
        return [
          ...
          createVNode("div", { class: "min-h-screen flex flex-col justify-end items-center md:items-end px-4 md:px-8 pb-12 md:pb-16 z-40 w-full" }, [
            createVNode("div", { class: "text-background_color text-center md:text-right max-w-2xl" }, [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d5e60a20"]]);
export {
  index as default
};
//# sourceMappingURL=index-CtIc2jWc.js.map
