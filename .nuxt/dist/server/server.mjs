...
const _routes = [
  ...
  },
  {
    ...
    path: "/shop",
    component: () => import("./_nuxt/shop-FarwoTeB.js"),
    children: [
      {
        name: "shop",
        path: "",
        component: () => import("./_nuxt/index-CiH0SmgG.js")
      }
    ]
  },
  {
    ...
    path: "/about",
    component: () => import("./_nuxt/about-D36coMfg.js"),
    children: [
      {
        name: "about",
        path: "",
  ...
  },
  {
    ...
    path: "/collections",
    component: () => import("./_nuxt/collections-danHPWXc.js"),
    children: [
      {
        name: "collections",
        path: "",
