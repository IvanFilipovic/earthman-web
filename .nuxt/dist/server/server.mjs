import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, resolveComponent, defineAsyncComponent, Fragment, createVNode, Text, Suspense, mergeProps, withCtx, useSSRContext, createTextVNode, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/user/earthman-web/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/user/earthman-web/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/home/user/earthman-web/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia } from "pinia";
import { defu, defuFn } from "/home/user/earthman-web/node_modules/defu/dist/defu.mjs";
...
import { toRouteMatcher, createRouter } from "/home/user/earthman-web/node_modules/radix3/dist/index.mjs";
import { klona } from "/home/user/earthman-web/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "/home/user/earthman-web/node_modules/@unhead/vue/dist/index.mjs";
import { createPathIndexLanguageParser, parseAcceptLanguage } from "@intlify/utils";
import { parse as parse$1 } from "/home/user/earthman-web/node_modules/cookie-es/dist/index.mjs";
import destr from "/home/user/earthman-web/node_modules/destr/dist/index.mjs";
import { isEqual as isEqual$1 } from "/home/user/earthman-web/node_modules/ohash/dist/index.mjs";
import { setupDevtoolsPlugin } from "@vue/devtools-api";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon } from "@iconify/vue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
import { getIconCSS } from "@iconify/utils/lib/css/icon";
import { debounce } from "/home/user/earthman-web/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "faq___en",
    path: "/faq",
    component: () => import("./_nuxt/faq-BY-zrrdS.js")
  },
  {
    name: "cart___en",
    path: "/cart",
    component: () => import("./_nuxt/cart-qU9x5Rbe.js")
  },
  {
    name: __nuxt_page_meta$2?.name,
    path: "/shop",
    component: () => import("./_nuxt/shop-Bo2OBZP2.js"),
    children: [
      {
        name: "shop___en",
        path: "",
        component: () => import("./_nuxt/index-C4QoDR2c.js")
      }
    ]
  },
  {
    ...
    path: "/about",
    component: () => import("./_nuxt/about-CvD1ho7a.js"),
    children: [
      {
        name: "about___en",
        path: "",
        component: () => import("./_nuxt/index-CvVwFNIv.js")
      }
    ]
  },
  {
    name: "index___en",
    path: "/",
    component: () => import("./_nuxt/index-UPmLXbTH.js")
  },
  {
    name: "terms___en",
    path: "/terms",
    component: () => import("./_nuxt/terms-BSr5-oL3.js")
  },
  {
    name: "contact___en",
    path: "/contact",
    component: () => import("./_nuxt/contact-BN54mgcf.js")
  },
  {
    name: "privacy___en",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-equFgvOf.js")
  },
  {
    name: "checkout___en",
    path: "/checkout",
    component: () => import("./_nuxt/checkout-BKcw7QkH.js")
  },
  {
    name: "thank-you___en",
    path: "/thank-you",
    component: () => import("./_nuxt/thank-you-D0Cm6tEo.js")
  },
  {
    name: "size-guide___en",
    path: "/size-guide",
    component: () => import("./_nuxt/size-guide-C6DdH_tg.js")
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/collections",
    component: () => import("./_nuxt/collections-YlnJ8oZD.js"),
    children: [
      {
        name: "collections___en",
        path: "",
        component: () => import("./_nuxt/index-67jbt6eI.js")
      },
      {
        name: "collections-slug___en",
        path: ":slug(.*)*",
        component: () => import("./_nuxt/_...slug_-Bowejh7Q.js")
      }
    ]
  },
  {
    ...
    path: "/payment/card",
    component: () => import("./_nuxt/card-DnAMvf1x.js")
  },
  {
    name: "cookie-policy___en",
    path: "/cookie-policy",
    component: () => import("./_nuxt/cookie-policy-tiO8s_dH.js")
  },
  {
    name: "privacy-policy___en",
    path: "/privacy-policy",
    component: () => import("./_nuxt/privacy-policy-D_1-9dIi.js")
  },
  {
    name: "delivery-returns___en",
    path: "/delivery-returns",
    component: () => import("./_nuxt/delivery-returns-LtnVyXB9.js")
  },
  {
    name: "terms-conditions___en",
    path: "/terms-conditions",
    component: () => import("./_nuxt/terms-conditions-DDsIsX9X.js")
  },
  {
    name: "payment-paypal-cancel___en",
    path: "/payment/paypal/cancel",
    component: () => import("./_nuxt/cancel-Bs35Fq5r.js")
  },
  {
    name: "payment-paypal-success___en",
    path: "/payment/paypal/success",
    component: () => import("./_nuxt/success-DnniZpDT.js")
  },
  {
    name: "product-collection-product___en",
    path: "/product/:collection()/:product(.*)*",
    component: () => import("./_nuxt/_...product_-COxCIJvf.js")
  }
];
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_8e13b12e",
      load: () => import(
        "./_nuxt/en-D32wdEvh.js"
        /* webpackChunkName: "locale_en_46json_8e13b12e" */
      ),
      cache: true
    }
  ]
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-Btb2etbb.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex items-center justify-center px-4 relative overflow-hidden" }, _attrs))} data-v-9057aaf6><div class="absolute inset-0 pointer-events-none bg-background_color" data-v-9057aaf6><!--[-->`);
      ssrRenderList(50, (i) => {
        _push(`<div class="absolute w-1 h-1 bg-text_color/30 rounded-full" style="${ssrRenderStyle(getStarStyle())}"${ssrRenderAttr("data-speed", Math.random() * 2 + 1)} data-v-9057aaf6></div>`);
      });
      _push(`<!--]--></div><div class="max-w-3xl w-full text-center relative z-10 text-text_color" data-v-9057aaf6><div class="relative mb-8 glitch-container" data-v-9057aaf6><h1 class="text-[120px] md:text-[200px] font-bold leading-none glitch text-text_color" data-text="404" data-v-9057aaf6> 404 </h1></div><h2 class="text-2xl md:text-4xl font-bold mb-4" data-v-9057aaf6> Houston, we have a problem </h2><p class="text-base md:text-lg opacity-70 mb-8 max-w-md mx-auto" data-v-9057aaf6> This page is lost somewhere between Earth and Mars. Let&#39;s navigate you back to familiar territory. </p><div class="flex flex-col sm:flex-row gap-4 justify-center items-center" data-v-9057aaf6><button class="btn btn--primary w-full sm:w-auto group" data-v-9057aaf6><span class="btn__text flex items-center gap-2" data-v-9057aaf6>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:earth",
        class: "w-4 h-4 group-hover:scale-110 transition-transform"
      }, null, _parent));
      _push(` Return to Earth </span><span class="btn__fill" data-v-9057aaf6></span></button>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="btn__text flex items-center gap-2" data-v-9057aaf6${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "lucide:shopping-bag",
              class: "w-4 h-4 group-hover:scale-110 transition-transform"
            }, null, _parent2, _scopeId));
            _push2(` Explore Shop </span><span class="btn__fill" data-v-9057aaf6${_scopeId}></span>`);
          } else {
            return [
              createVNode("span", { class: "btn__text flex items-center gap-2" }, [
                createVNode(_component_Icon, {
                  name: "lucide:shopping-bag",
                  class: "w-4 h-4 group-hover:scale-110 transition-transform"
                }),
                createTextVNode(" Explore Shop ")
              ]),
      ...
      _push(`</div><div class="mt-12 text-sm opacity-50" data-v-9057aaf6><p data-v-9057aaf6>Auto-redirecting in ${ssrInterpolate(unref(countdown))}s...</p><button class="underline hover:no-underline mt-2" data-v-9057aaf6> Cancel </button></div></div></div>`);
    };
  }
});
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-9057aaf6"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
