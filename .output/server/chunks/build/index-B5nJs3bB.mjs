...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-cfea9f34><div class="flex flex-col md:flex-row items-start md:items-center justify-between px-8 py-6 gap-6 border-b border-text_color/30" data-v-cfea9f34><div class="w-full md:w-1/2" data-v-cfea9f34><div class="image bg-cover bg-center bg-transparent h-40 flex justify-center max-w-[100%]" data-v-cfea9f34></div></div><div class="w-full md:w-1/2 flex flex-col" data-v-cfea9f34>`);
      _push(ssrRenderComponent(_sfc_main$2, { dark: false }, null, _parent));
      _push(`<div class="flex gap-3 justify-end w-full" data-v-cfea9f34><div class="flex items-center gap-3" data-v-cfea9f34><span class="uppercase text-xs tracking-widest ml-4" data-v-cfea9f34>View</span><!--[-->`);
      ssrRenderList(totalPages.value, (p) => {
        _push(`<button class="${ssrRenderClass([p === page.value ? "underline" : "opacity-60", "text-sm uppercase tracking-widest"])}" data-v-cfea9f34>${ssrInterpolate(p)}</button>`);
      });
      _push(`<!--]--><button class="text-md uppercase tracking-widest px-4" data-v-cfea9f34>Filters</button></div></div></div></div><div class="flex flex-col md:flex-row items-start md:items-center justify-between px-8 pt-1 gap-6" data-v-cfea9f34><div class="flex justify-end w-full" data-v-cfea9f34><div class="flex items-center" data-v-cfea9f34><button class="${ssrRenderClass(genderBtnClass("female"))}" data-v-cfea9f34>WOMAN</button><button class="${ssrRenderClass(genderBtnClass("male"))}" data-v-cfea9f34>MAN</button></div></div></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cfea9f34"]]);

export { index as default };
//# sourceMappingURL=index-B5nJs3bB.mjs.map
