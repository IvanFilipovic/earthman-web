import { withCtx, createVNode, defineComponent, ref, mergeProps, computed, createTextVNode, unref, useAttrs, useSSRContext } from 'vue';
...
import { _ as _export_sfc, c as useRoute, d as __nuxt_component_1$1, e as useRuntimeConfig, u as useHead, k as useNuxtApp, w as withLeadingSlash, h as hasProtocol, j as joinURL, p as parseURL, g as encodeParam, i as encodePath } from './server.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-7pp3EPK3.mjs';
import { _ as __nuxt_component_0$2 } from './index-qGNUStbk.mjs';
import { u as useFetch } from './fetch-XHfbX9bC.mjs';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-8 py-6 gap-6" }, _attrs))} data-v-9bd0c65a><div class="hidden md:flex flex-col w-full" data-v-9bd0c65a><div class="w-full" data-v-9bd0c65a>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "image bg-cover bg-center bg-transparent h-40 flex justify-start max-w-[100%] -ml-20"
      }, null, _parent));
      _push(`</div><div class="flex" data-v-9bd0c65a><div class="flex flex-row justify-start w-full mx-auto gap-x-4 py-4" data-v-9bd0c65a>`);
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</div></div><div class="flex md:hidden items-center justify-between w-full px-2" data-v-9bd0c65a><div class="w-[60%]" data-v-9bd0c65a>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "image bg-cover bg-center bg-transparent h-12 flex justify-start max-w-[100%]"
      }, null, _parent));
      _push(`</div><div class="flex items-center gap-4" data-v-9bd0c65a>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`<button data-v-9bd0c65a>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-9bd0c65a"]]);
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderSuspense(_push, {
        default: () => {
          _push(`<div class="grid grid-cols-1 md:grid-cols-2 w-full h-auto lg:h-screen overflow-hidden" data-v-2fc7cdd7><!--[-->`);
          ssrRenderList(unref(collections), (collection) => {
            _push(`<div class="relative w-full pt-[100%] bg-cover bg-center overflow-hidden" style="${ssrRenderStyle({ backgroundImage: `url(${collection.element_one_image})` })}" data-v-2fc7cdd7><div class="overlay absolute top-0 left-0 right-0 flex flex-col md:flex-row justify-end md:justify-end h-full" data-v-2fc7cdd7><div class="flex flex-col space-y-3 md:space-y-2 px-8 py-8 md:pb-8 md:px-8 items-center md:items-end justify-end md:w-[60%] text-center md:text-right h-full" data-v-2fc7cdd7><h2 class="text-base sm:text-lg md:text-2xl font-medium md:font-bold text-text_color bg-background_color/60 px-4 py-1 uppercase tracking-wider w-[60%] md:w-full inline-flex items-center justify-center" data-v-2fc7cdd7>${ssrInterpolate(collection.name)}</h2>`);
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<span class="btn-label" data-v-2fc7cdd7${_scopeId}>View project</span><span class="sweep-overlay" aria-hidden="true" data-v-2fc7cdd7${_scopeId}></span>`);
                } else {
                  return [
        ...
        fallback: () => {
          _push(`<div class="flex items-center justify-center h-screen" data-v-2fc7cdd7> Loading collections\u2026 </div>`);
        },
        _: 1
      });
    };
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-2fc7cdd7"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(items.value, (p) => {
        var _a;
        _push(`<div class="keen-slider__slide px-2 my-auto" data-v-791f1305><div class="w-full" data-v-791f1305><div class="w-full overflow-hidden border-text_color/30 bg-background_color" data-v-791f1305><img${ssrRenderAttr("src", ((_a = firstColor(p)) == null ? void 0 : _a.avatar_image) || p.link_image)}${ssrRenderAttr("alt", p.alt_text || p.name)} class="w-full object-cover" loading="lazy" decoding="async" data-v-791f1305></div><div class="mt-3 text-sm text-text_color truncate text-center" data-v-791f1305>${ssrInterpolate(p.name)}</div></div></div>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
  ...
  _push(ssrRenderComponent(_component_BackgroundVideo, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_NuxtLink, {
          to: "/shop",
          class: "secondary-btn sweep-secondary w-fit self-end px-4 py-2"
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
...
//# sourceMappingURL=index-CBxom8lS.mjs.map
