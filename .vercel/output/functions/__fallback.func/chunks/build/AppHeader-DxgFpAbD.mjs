...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "flex flex-col w-full bg-transparent z-50 my-auto" }, _attrs))} data-v-7109113a><div class="image bg-cover bg-center bg-transparent h-40 flex justify-center max-w-[100%]" data-v-7109113a></div><div class="flex pt-4" data-v-7109113a><div class="flex flex-row justify-center w-full mx-auto space-x-4 py-4" data-v-7109113a>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7109113a"]]);

export { __nuxt_component_0 as _, useFetch as u };
//# sourceMappingURL=AppHeader-DxgFpAbD.mjs.map
