import { defineComponent, ref, mergeProps, computed, withCtx, createVNode, useAttrs, unref, useSSRContext } from 'vue';
...
import { _ as _export_sfc, g as useRouter, e as __nuxt_component_0$3, h as useHead, i as useNuxtApp, c as useRuntimeConfig, w as withLeadingSlash, j as hasProtocol, k as joinURL, p as parseURL, l as encodeParam, m as encodePath } from './server.mjs';
        ...
        if (s.type === "cta") {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a, _b;
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", ((_a = firstColor(s.item)) == null ? void 0 : _a.avatar_image) || s.item.link_image)}${ssrRenderAttr("alt", s.item.alt_text || s.item.name)} class="w-full object-cover border border-text_color/30" loading="lazy" decoding="async" data-v-e1de93e9${_scopeId}>`);
              } else {
                return [
                  createVNode("img", {
...
export { __nuxt_component_0 as _, __nuxt_component_4 as a, _sfc_main as b };
//# sourceMappingURL=Newsletter-DUEYXif7.mjs.map
