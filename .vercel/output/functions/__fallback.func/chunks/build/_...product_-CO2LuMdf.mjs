...
import { _ as _export_sfc, e as useRoute, q as useAsyncData, g as useRuntimeConfig, d as useRouter, a as __nuxt_component_0$3, c as __nuxt_component_0$1 } from './server.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_b = unref(product)) == null ? void 0 : _b.discount) {
        _push(`<div class="space-x-2" data-v-ebf6a258><span class="text-lg font-semibold text-text_color" data-v-ebf6a258>\u20AC${ssrInterpolate((_c = unref(product)) == null ? void 0 : _c.discount_price)}</span><span class="line-through text-text_color" data-v-ebf6a258>\u20AC${ssrInterpolate((_d = unref(product)) == null ? void 0 : _d.price)}</span></div>`);
      } else {
        _push(`<div class="text-lg font-semibold text-text_color" data-v-ebf6a258>\u20AC${ssrInterpolate((_e = unref(product)) == null ? void 0 : _e.price)}</div>`);
      }
      _push(`</div></div>`);
      ...
      if (unref(activeSizes).length) {
        ...
        ssrRenderList(unref(activeSizes), (s) => {
          ...
          ], "border px-2 py-2 text-sm text-text_color"])}"${ssrIncludeBooleanAttr(!s.available) ? " disabled" : ""} data-v-ebf6a258>${ssrInterpolate((_a2 = s.size) == null ? void 0 : _a2.name)}</button>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(variantGroups).length) {
        ...
        ssrRenderList(unref(variantGroups), (vg, idx) => {
          var _a2;
          _push(`<button class="${ssrRenderClass([unref(activeColorIndex) === idx ? "ring-2 ring-text_color" : "", "w-8 h-8 border"])}" style="${ssrRenderStyle({ backgroundColor: swatchBg((_a2 = vg.color) == null ? void 0 : _a2.image) })}" data-v-ebf6a258></button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(activeColorName)) {
          _push(`<p class="mt-1 text-sm text-text_color" data-v-ebf6a258>Color: ${ssrInterpolate(unref(activeColorName))}</p>`);
...
We accept returns within 14 days. Sale items can only be refunded as store credit.`,
      ...
      if ((_i = unref(product)) == null ? void 0 : _i.discount) {
        _push(`<div class="space-x-1" data-v-ebf6a258><span class="text-base font-semibold text-text_color" data-v-ebf6a258>\u20AC${ssrInterpolate((_j = unref(product)) == null ? void 0 : _j.discount_price)}</span><span class="line-through text-text_color text-sm" data-v-ebf6a258>\u20AC${ssrInterpolate((_k = unref(product)) == null ? void 0 : _k.price)}</span></div>`);
      } else {
        _push(`<div class="text-base font-semibold text-text_color" data-v-ebf6a258>\u20AC${ssrInterpolate((_l = unref(product)) == null ? void 0 : _l.price)}</div>`);
      }
                              ...
                              if (unref(activeSizes).length) {
                                ...
                                ssrRenderList(unref(activeSizes), (s) => {
                                  ...
                                  _push5(`<button class="${ssrRenderClass([[
                                    s.available ? "cursor-pointer" : "opacity-40 cursor-not-allowed",
                                    unref(selectedVariantSlug) === s.slug ? "border-text_color" : "border-project_gray/50"
                                  ], "border px-3 py-2 text-sm w-fit"])}" data-v-ebf6a258${_scopeId4}>${ssrInterpolate((_a2 = s.size) == null ? void 0 : _a2.name)}</button>`);
                                });
                                _push5(`<!--]--></div></div>`);
                              } else {
                                _push5(`<!---->`);
...
//# sourceMappingURL=_...product_-CO2LuMdf.mjs.map
