...
import { _ as _export_sfc, e as __nuxt_component_0$3, d as __nuxt_component_0$1, c as useRuntimeConfig, n as navigateTo } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const lineTotal = (it) => {
      var _a, _b;
      return toNum((_a = it.unit_price_discounted) != null ? _a : it.unit_price_original) * ((_b = it.quantity) != null ? _b : 0);
    };
    ...
    async function fetchCart() {
      ...
      try {
        ...
        res.items = ((_a = res.items) != null ? _a : []).map((i) => {
          var _a2;
          return { ...i, size: (_a2 = i.size) != null ? _a2 : i.product_size };
        });
        cart.value = res;
      } finally {
    ...
    const itemSlug = (it) => {
      var _a;
      return (_a = it.product_variant_slug) != null ? _a : it.product_slug;
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cart).items.length) {
        ...
        ssrRenderList(unref(cart).items, (it, i) => {
          ...
          _push(`</div><button class="mt-3 text-xs uppercase tracking-widest border-b border-text_color/30"${ssrIncludeBooleanAttr(unref(removingSlug) === ((_a = it.product_variant_slug) != null ? _a : it.product_slug)) ? " disabled" : ""} data-v-59d95f90> Remove item </button></div></div>`);
        });
        _push(`<!--]--></div>`);
      } else {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(unref(cart).items, (it, i) => {
                    ...
                    _push3(`</div></div><button class="shrink-0 p-1 hover:bg-text_color/10 rounded-sm h-7"${ssrIncludeBooleanAttr(unref(removingSlug) === ((_a = it.product_variant_slug) != null ? _a : it.product_slug)) ? " disabled" : ""} aria-label="Remove item" title="Remove" data-v-59d95f90${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_Icon, {
                      name: "lucide:x",
                      class: "w-4 h-4"
                    }, null, _parent3, _scopeId2));
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(cart).items, (it, i) => {
                        ...
                        return openBlock(), createBlock("div", {
                          ...
                          createVNode("button", {
                            ...
                            disabled: unref(removingSlug) === ((_a = it.product_variant_slug) != null ? _a : it.product_slug),
...
//# sourceMappingURL=checkout-DkwtQLOP.mjs.map
