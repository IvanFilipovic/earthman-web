...
import { _ as _export_sfc, a as __nuxt_component_0$3, c as __nuxt_component_0 } from './server.mjs';
import { mergeProps, withCtx, createTextVNode, toDisplayString, defineComponent, unref, useSSRContext } from 'vue';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-background_color text-text_color border-t border-text_color/30" }, _attrs))}><div class="max-w-7xl px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8"><!--[-->`);
      ...
      _push(`<!--]--></div><div class="border-t border-text_color/30"><div class="max-w-7xl mx-auto px-6 flex flex-col items-center py-6"><img${ssrRenderAttr("src", _imports_0)} alt="Your Brand Name" class="max-w-[100%] h-auto mb-6"><p class="text-xs">\xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Earthman. All rights reserved.</p></div></div></footer>`);
    };
  }
};
...
//# sourceMappingURL=default-C-hHjkkn.mjs.map
