...
import { _ as _export_sfc, a as __nuxt_component_0$3, e as useRoute, f as __nuxt_component_1$1, c as __nuxt_component_0$1, g as useRuntimeConfig, u as useHead, m as useNuxtApp, w as withLeadingSlash, i as hasProtocol, j as joinURL, p as parseURL, k as encodeParam, l as encodePath } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<section${ssrRenderAttrs(_attrs)} data-v-ad6a6065><div class="flex flex-col lg:flex-row w-full" data-v-ad6a6065><div class="flex flex-col w-full lg:w-1/2 h-full bg-background_color" data-v-ad6a6065>`);
  _push(ssrRenderComponent(_component_BackgroundVideo, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="absolute inset-x-0 top-0 w-full" data-v-ad6a6065${_scopeId}>`);
        _push2(ssrRenderComponent(_component_AppHeader, { dark: true }, null, _parent2, _scopeId));
        _push2(`</div><div class="absolute inset-x-0 bottom-6 md:bottom-0 left-0 flex items-center flex-col pb-8 text-background_color px-4 md:text-end md:self-end" data-v-ad6a6065${_scopeId}><h1 class="text-4xl md:text-6xl font-bold mb-4 self-center text-center md:self-end" data-v-ad6a6065${_scopeId}>Welcome to Our Shop</h1><p class="md:self-end mb-8 self-center text-center" data-v-ad6a6065${_scopeId}>Explore our latest collection with immersive video background.</p>`);
        _push2(ssrRenderComponent(_component_NuxtLink, {
          to: "/shop",
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<span class="btn-label" data-v-ad6a6065${_scopeId2}>Shop Now</span><span class="sweep-overlay" aria-hidden="true" data-v-ad6a6065${_scopeId2}></span>`);
            } else {
              return [
  ...
  _push(`</div><div class="flex flex-col w-full lg:w-1/2 min-h-screen" data-v-ad6a6065>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-ad6a6065"]]);

export { index as default };
//# sourceMappingURL=index-CrmX3C6v.mjs.map
