import { _ as __nuxt_component_0 } from './index-Bc_SW2bH.mjs';
...
import { _ as _export_sfc, b as useRouter, c as useRoute, d as __nuxt_component_0$2 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function fetchProducts() {
      const res = await $fetch(`${API_BASE}/public/products-all/?${buildQuery()}`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-0c81cb24><div class="flex flex-col md:flex-row items-start md:items-center justify-between px-8 py-6 gap-6 border-b border-text_color/30" data-v-0c81cb24><div class="w-full md:w-1/2" data-v-0c81cb24><div class="image bg-cover bg-center bg-transparent h-40 flex justify-center max-w-[100%]" data-v-0c81cb24></div></div><div class="w-full md:w-1/2 flex flex-col" data-v-0c81cb24>`);
      _push(ssrRenderComponent(_sfc_main$2, { dark: false }, null, _parent));
      _push(`<div class="flex gap-3 justify-end w-full" data-v-0c81cb24><div class="flex items-center gap-3" data-v-0c81cb24><span class="uppercase text-xs tracking-widest ml-4" data-v-0c81cb24>View</span><!--[-->`);
      ssrRenderList(totalPages.value, (p) => {
        _push(`<button class="${ssrRenderClass([p === page.value ? "underline" : "opacity-60", "text-sm uppercase tracking-widest"])}" data-v-0c81cb24>${ssrInterpolate(p)}</button>`);
      });
      _push(`<!--]--><button class="text-md uppercase tracking-widest px-4" data-v-0c81cb24>Filters</button></div></div></div></div><div class="flex flex-col md:flex-row items-start md:items-center justify-between px-8 pt-1 gap-6" data-v-0c81cb24><div class="flex justify-end w-full" data-v-0c81cb24><div class="flex items-center" data-v-0c81cb24><button class="${ssrRenderClass(genderBtnClass("female"))}" data-v-0c81cb24>WOMAN</button><button class="${ssrRenderClass(genderBtnClass("male"))}" data-v-0c81cb24>MAN</button></div></div></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0c81cb24"]]);

export { index as default };
//# sourceMappingURL=index-dcqkqEH1.mjs.map
