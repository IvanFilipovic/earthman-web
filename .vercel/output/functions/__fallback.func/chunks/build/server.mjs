import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, ref, inject, Suspense, computed, hasInjectionContext, getCurrentInstance, provide, cloneVNode, createElementBlock, toValue, onServerPrefetch, shallowReactive, Fragment, toRef, nextTick, unref, defineAsyncComponent, useSSRContext, createApp, withCtx, createTextVNode, createVNode, createBlock, createCommentVNode, openBlock, onErrorCaptured, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, Text } from 'vue';
import { w as klona, x as defuFn, y as sanitizeStatusCode, z as getContext, c as createError$1, $ as $fetch$1, A as baseURL, B as createHooks, C as executeAsync, D as destr, E as toRouteMatcher, F as createRouter$1, G as defu, H as getRequestURL, I as parse$1, J as getRequestHeader, K as isEqual$1, L as setCookie, g as getCookie, M as deleteCookie } from '../nitro/nitro.mjs';
...
import { gsap as gsap$4 } from 'gsap';
...
var _doc$3,
  ...
  if (doc) {
    ...
    _body$4 = doc.body;
    _gEl = _doc$3.createElementNS("http://www.w3.org/2000/svg", "g"); // prevent any existing CSS from transforming it
...
_parseRect = function _parseRect(e) {
  ...
  var doc = e.ownerDocument || _doc$2,
...
_getElementBounds = function _getElementBounds(element, context) {
  ...
  var isSVG = element.getBBox && element.ownerSVGElement,
      doc = element.ownerDocument || _doc$2,
      left,
      right,
      top,
      bottom,
  ...
  } else if (context === _win$2 || _isUndefined(context)) {
  ...
  function Draggable(target, vars) {
    ...
    syncXY = function syncXY(skipOnUpdate, skipSnap) {
      ...
      if (vars.liveSnap) {
        ...
        snapIsRaw = _isArray(snap) || _isFunction$2(snap);
    ...
    onPress = function onPress(e, force) {
      ...
      if (isPreventingDefault) {
        ...
        _addListener$2(_win$2, "touchforcechange", _preventDefault); //works around safari bug: https://gsap.com/forums/topic/21450-draggable-in-iframe-on-mobile-is-buggy/
      ...
      if (touchEventTarget && allowNativeTouchScrolling && !touchDragAxis) {
        ...
        if (dx !== dy && (dx > minimumMovement || dy > minimumMovement) || _isAndroid) {
          ...
          if (allowNativeTouchScrolling && touchDragAxis !== allowNativeTouchScrolling) {
            _addListener$2(_win$2, "touchforcechange", _preventDefault); // prevents native touch scrolling from taking over if the user started dragging in the other direction in iOS Safari
    ...
    _context$2(_assertThisInitialized(_this2));
...
gsap$4.registerPlugin(ScrollTrigger, ScrollToPlugin, Draggable, TextPlugin);
...
const vGsapDirective = (appType, configOptions, gsapContext, resizeListener) => ({
  ...
  async beforeMount(el, binding, vnode) {
    ...
    if (!gsapContext) gsapContext = gsap$4.context(() => {
    });
...
function prepareTimeline(el, binding, configOptions) {
  ...
  const timeline = gsap$4.timeline(timelineOptions);
  if (binding.modifiers.parallax) {
        ...
        return [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              ...
              createVNode(_component_CookieControl)
            ]),
            _: 1
          })
        ];
